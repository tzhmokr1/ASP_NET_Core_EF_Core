...
namespace chapter6.DataAccess
{
    public class LeanTrainingDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                string connection = "server=localhost;port=3306;database=lean_training;uid=root;pwd=root";
            ...
            where T : Entity
        {
            ...
            // entity.Property<DateTime>("CreatedAt").IsRequired().HasDefaultValueSql("CURRENT_TIMESTAMP");
            // entity.Property<DateTime>("UpdatedAt").IsRequired().HasDefaultValueSql("CURRENT_TIMESTAMP");
